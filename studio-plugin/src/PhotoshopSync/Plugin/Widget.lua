...
function Widget:render()
    ...
    for i, stateData in availableSessions do
        local newTexture = e(SyncableTexture, Cryo.Dictionary.join(stateData, {
            index = i,
            sessionData = {},
            hasPolling = false,
    ...
    return e("ScrollingFrame", {
        ...
        selected = if hasSessionTextures then e("Frame", {
            Size = UDim2.new(1, 0, 0, 0),
            BackgroundTransparency = 1,
        ...
        }, sessionTextures)) else nil,
        spacer2 = if hasSessionTextures and hasLockedTextures then e("Frame", {
            Size = UDim2.new(1, 0, 0, 5),
            BackgroundColor3 = Color3.new(),
            LayoutOrder = 2,
        }) else nil,
        active_edits = if hasLockedTextures then e("Frame", {
            Size = UDim2.new(1, 0, 0, 0),
